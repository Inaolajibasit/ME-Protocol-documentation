...
const ListHeader = ({ children }: { children: ReactNode }) => {
  return (
    <Text fontWeight={'500'} fontSize={'md'} color={'#a1a1a1'} mb={2}>
      {children}
    </Text>
  )
}
      ...
      <Container as={Stack} maxW={'6xl'} py={10}>
        <SimpleGrid columns={{ base: 1, sm: 2, md: 4 }} spacing={8}>
          <Stack align={'flex-start'}>
            <ListHeader>Our Research </ListHeader>
            <Box mb={2} fontSize={'13px'} as="a" href={'#'}>
              Overview
            </Box>
            <Box mb={2} fontSize={'13px'} as="a" href={'#'}>
              Index
          ...
          <Stack align={'flex-start'}>
            ...
            <Box mb={2} fontSize={'13px'} as="a" href={'#'}>
              ChatGPT Login <Icon as={GoArrowUpRight }  />
            </Box>
            <Box mb={2} fontSize={'13px'} as="a" href={'#'}>
              Download
            </Box>
          ...
          <Stack align={'flex-start'}>
            <ListHeader>Safety overview</ListHeader>
            <Box mb={2} fontSize={'13px'} as="a" href={'#'}>
              Safety Overview
            </Box>
            <Box mb={2} fontSize={'13px'} as="a" href={'#'}>
          ...
          <Stack align={'flex-start'}>
            <ListHeader>Latest Advancements</ListHeader>
            <Box mb={2} fontSize={'13px'} as="a" href={'#'}>
              GPT-4 
            </Box>
            <Box mb={2} fontSize={'13px'} as="a" href={'#'}>
          ...
          <Stack align={'flex-start'}>
            ...
            <Box mb={2} fontSize={'13px'} as="a" href={'#'}>
              Documentation <Icon as={GoArrowUpRight }  />
            </Box>
            <Box mb={2} fontSize={'13px'} as="a" href={'#'}>
              API Login <Icon as={GoArrowUpRight }  />
            </Box>
          </Stack>
          <Stack align={'flex-start'}>
            <ListHeader>Teams</ListHeader>
            <Box mb={2} fontSize={'13px'} as="a" href={'#'}>
              Safety Systems
            </Box>
            <Box mb={2} fontSize={'13px'} as="a" href={'#'}>
          ...
          <Stack align={'flex-start'}>
            <ListHeader>Explore more</ListHeader>
            <Box mb={2} fontSize={'13px'} as="a" href={'#'}>
              OpenAI for Business
            </Box>
            <Box mb={2} fontSize={'13px'} as="a" href={'#'}>
